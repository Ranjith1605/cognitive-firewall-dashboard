...
const FOCUSED_DAILY = {
    ...
    "interaction_effort": 0.12,
    "context_pressure": 0.18,
    "avg_tab_switches_per_day": 9.2,
    "context_switches_per_day": 4,
    "click_rate_per_min": 12.5,
    "scroll_variance": 0.08,
    "revisited_pages_per_day": 35,
    "clear_decisions_moment": "Night",
    "more_hesitation_moment": "Late morning",
...
const FRAGMENTED_DAILY = {
    ...
    "attention_fragmentation": 0.82,
    "interaction_effort": 0.65,
    "context_pressure": 0.75,
    "avg_tab_switches_per_day": 25.9,
    "context_switches_per_day": 18,
    "click_rate_per_min": 45.2,
    "scroll_variance": 0.42,
    "revisited_pages_per_day": 91,
    "clear_decisions_moment": "Night",
    "more_hesitation_moment": "Late evening",
